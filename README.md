# Claim Verification Toolkit

Open tooling and methods for tracing claims back to primary sources — surfacing provenance so readers can judge for themselves, explicitly without acting as an arbiter of truth.
